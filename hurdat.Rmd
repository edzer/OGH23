...
We will use a hurricane dataset and aggretate it to a spatiotemporal datacube.
...
# use stars for rectilinear grid with equal-area grid cells
```{r}
library(stars)
